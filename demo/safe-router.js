...
function routeQuestion(input, context = {}) {
  ...
  if (crisis.test(q)) {
    return answer("Если есть риск причинить вред себе или кому-то, пожалуйста, прямо сейчас позвоните в местные экстренные службы или обратитесь к близкому человеку рядом. Этот помощник не заменяет экстренную помощь.", [], "crisis");
  }
